...
namespace SteamFakePlayer.Steam.Core
{
    ...
    public class Buffer : ISerializable
    {
        ...
        {
            var write_size = Length();
            if (write_size > max_length)
            {
                write_size = max_length;
            }
